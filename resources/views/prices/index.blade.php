                    ...
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <p class="text-gray-700 mt-2">
                                Preu actual: <span class="font-bold">{{ number_format($price->price, 2) }}€</span>
                            </p>
                            <p class="text-gray-700">
                                Descompte: <span class="font-bold">{{ $price->discount }}%</span>
                            </p>
                            <p class="text-gray-700">
                                Preu amb descompte: <span class="font-bold">
                                    {{ number_format($price->price - ($price->price * $price->discount / 100), 2) }}€
                                </span>
                            </p>
                            <p class="text-gray-700">
